...
HAL_StatusTypeDef HAL_RCC_DeInit(void)
{
  ...
  {
    if ((hal_get_tick() - tickstart) > MSI_TIMEOUT_VALUE)
    {
      return HAL_TIMEOUT;
    }
  }
  ...
  {
    if ((hal_get_tick() - tickstart) > CLOCKSWITCH_TIMEOUT_VALUE)
    {
      return HAL_TIMEOUT;
    }
  }
...
#endif
  {
    if ((hal_get_tick() - tickstart) > PLL_TIMEOUT_VALUE)
    {
      return HAL_TIMEOUT;
    }
  }
...
HAL_StatusTypeDef HAL_RCC_OscConfig(RCC_OscInitTypeDef *RCC_OscInitStruct)
{
  ...
  if (((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_HSE) == RCC_OSCILLATORTYPE_HSE)
  {
    ...
    else
    {
      ...
      if (RCC_OscInitStruct->HSEState != RCC_HSE_OFF)
      {
        ...
        {
          if ((hal_get_tick() - tickstart) > HSE_TIMEOUT_VALUE)
          {
            return HAL_TIMEOUT;
          }
        }
  ...
  if (((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_HSI) == RCC_OSCILLATORTYPE_HSI)
  {
    ...
    else
    {
      ...
      if (RCC_OscInitStruct->HSIState != RCC_HSI_OFF)
      {
        ...
        {
          if ((hal_get_tick() - tickstart) > HSI_TIMEOUT_VALUE)
          {
            return HAL_TIMEOUT;
          }
        }
    ...
    if (RCC_OscInitStruct->LSIState != RCC_LSI_OFF)
    {
      ...
      if (RCC_OscInitStruct->LSIDiv != (csr_temp & RCC_CSR_LSIPREDIV))
      {
        ...
        if ((csr_temp & RCC_CSR_LSION) == RCC_CSR_LSION)
        {
          ...
          {
            if ((hal_get_tick() - tickstart) > LSI_TIMEOUT_VALUE)
            {
              return HAL_TIMEOUT;
            }
          }
  ...
  if (((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_LSE) == RCC_OSCILLATORTYPE_LSE)
  {
    ...
    if (HAL_IS_BIT_CLR(PWR->CR1, PWR_CR1_DBP))
    {
      ...
      {
        if ((hal_get_tick() - tickstart) > RCC_DBP_TIMEOUT_VALUE)
        {
          return HAL_TIMEOUT;
        }
      }
    ...
    if (RCC_OscInitStruct->LSEState != RCC_LSE_OFF)
    {
      ...
      {
        if ((hal_get_tick() - tickstart) > RCC_LSE_TIMEOUT_VALUE)
        {
          return HAL_TIMEOUT;
        }
      }
  ...
  if (((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_HSI48) == RCC_OSCILLATORTYPE_HSI48)
  {
    ...
    if (RCC_OscInitStruct->HSI48State != RCC_HSI48_OFF)
    {
      ...
      {
        if ((hal_get_tick() - tickstart) > HSI48_TIMEOUT_VALUE)
        {
          return HAL_TIMEOUT;
        }
      }
